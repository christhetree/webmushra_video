...
MushraPage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  // var div2 = $('<video id="video" muted preload="auto"><source src="configs/resources/audio/room_tour_1.mp4" type="video/mp4"></video>');
  var videoDiv = $('<video id="video" muted></video>');
...
MushraPage.prototype.load = function () {
  ...
  this.videoPlayer = new VideoPlayer("video", "configs/resources/audio/room_tour_1.mp4", "video/mp4", this.mushraAudioControl);
...
MushraPage.prototype.save = function () {
  ...
  this.videoPlayer.removeEventListener(this.waveformVisualizer.numberEventListener);
  var scales = $(".scales");
  this.ratings = [];
  var i;
  for (i = 0; i  < scales.length; ++i) {
