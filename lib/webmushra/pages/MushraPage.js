...
MushraPage.prototype.save = function () {
  ...
  this.time = (saveTime - this.startTimeOnPage);
  console.log("time on page = " + this.time);
  if (this.videoPlayer && this.videoPlayer.timeFinishedLoading) {
    this.time = (saveTime - this.videoPlayer.timeFinishedLoading);
    console.log("time on page (after loading video) = " + this.time);
  }
