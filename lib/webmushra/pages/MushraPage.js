...
MushraPage.prototype.render = function (_parent) {
  ...
  if (this.pageConfig.checkRange) {
    _parent.append("<p>You must use the full range of the rating scale to proceed: your lowest rating must be between 0 and 25, and your highest rating must be between 75 and 100.</p>");
  }
  var content;
