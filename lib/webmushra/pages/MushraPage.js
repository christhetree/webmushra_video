...
MushraPage.prototype.render = function (_parent) {
  ...
  if (this.pageConfig.checkReference) {
    _parent.append("<p>During training, one of the conditions is the same as the reference. Since you are comparing the conditions to the reference, this hidden reference condition must be rated close to 50 to proceed (50 = preference equal to the reference).</p>");
  }
  var content;
...
MushraPage.prototype.lockOrUnlockNextButton = function () {
  console.log("lock function referenceRatingCloseTo50 = " + this.referenceRatingCloseTo50);
  // TODO(cm): simplify this
  if (this.pageConfig.mustRate && this.pageConfig.checkReference) {
    if (this.hasPlayedAllConditions && this.referenceRatingCloseTo50) {
  ...
  } else if (this.pageConfig.mustRate) {
    if (this.hasPlayedAllConditions) {
      console.log("unlocking");
      this.pageTemplateRenderer.unlockNextButton();
    } else {
      console.log("locking");
  ...
  } else if (this.pageConfig.checkReference) {
    if (this.referenceRatingCloseTo50) {
      console.log("unlocking");
      this.pageTemplateRenderer.unlockNextButton();
    } else {
      console.log("locking");
