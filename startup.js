  ...
  for (var i = 0; i < _pages.length; ++i) {
    if (Array.isArray(_pages[i])) {
      ...
      if (pageConfig.type == "generic") {
        ...
        var mushraPage = new MushraPage(_pageManager, pageTemplateRenderer, audioContext, config.bufferSize, audioFileLoader, session, pageConfig, mushraValidator, errorHandler, config.language);
